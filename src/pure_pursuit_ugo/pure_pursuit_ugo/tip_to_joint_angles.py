...
class IKCommandTester(Node):
    def __init__(self):
        super().__init__('ik_command_tester')
    ...
    def publish_ik_command(self):
        ...
        try:
            ...
            self.get_logger().info(
                ...
                f"Sent IK command to: x={x:.2f}, z={z:.2f}, α={alpha_deg:.1f}° → "
